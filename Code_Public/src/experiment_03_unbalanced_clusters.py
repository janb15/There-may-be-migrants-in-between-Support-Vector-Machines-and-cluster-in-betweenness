...
for sample_number in SAMPLES_NUMBERS:
    ...
    for s in SEEDS:
        print('Seed: ' + str(s) + 'Samples: ' + str(sample_number))
        print('Seed: ' + str(s)+ 'Samples: ' + str(sample_number))
        print('Seed: ' + str(s)+ 'Samples: ' + str(sample_number))
        print('Seed: ' + str(s)+ 'Samples: ' + str(sample_number))
...
dump(results, '/home/jan/CAU/Masterarbeit/master-thesis-jan-bensien/Code/experiment_result/experiment03_unbalanced_clusters.pkl')