...
for s in SEEDS:
    for multiplier in MULTIPLIERS:
        ...
        t1, t2 = calculate_thresholds_basic(data_train_scaled, model, multiplier)
        t2 = np.max(t2)
        # Drop labels
...
dump(results, '/home/jan/CAU/Masterarbeit/master-thesis-jan-bensien/Code/experiment_result/preparatory_experiment_threshold_1.pkl')