...
# Train the SVM Model and scale the test and train se
...
dump(results, '/home/jan/CAU/Masterarbeit/master-thesis-jan-bensien/Code/experiment_result/experiment01_per_years_seeds_multiplier_2.pkl')