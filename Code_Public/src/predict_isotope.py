...
# Change site group selection, grid path
...
# TODO: DELETE
#if isodata[isodata['206Pb/207Pb']>1.3].shape[0] > 1:
#    raise SystemExit("Deleted too many samples")
...
grid = load("/home/jan/CAU/Masterarbeit/master-thesis-jan-bensien/Code/models/grid_search_isotope_2-3_combined")
