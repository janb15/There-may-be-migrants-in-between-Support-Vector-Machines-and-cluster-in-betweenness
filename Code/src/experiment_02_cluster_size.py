...
# Experiment on the impact of the year of cluster sample size
...
for sample_number in SAMPLES_NUMBERS:
    ...
    for s in SEEDS:
        # Generate migrant samples - similar amount as test set
...
dump(results, 'experiment_result/experiment02_cluster_size.pkl')