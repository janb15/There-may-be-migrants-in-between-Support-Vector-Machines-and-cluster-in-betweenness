...
#MULTIPLIERS = [0.1,1,2,3,4,5, 100] # regular run
MULTIPLIERS = np.linspace(1,3,20) # fine tuning
...
for s in SEEDS:
    for multiplier in MULTIPLIERS:
        ...
        migrants = migrants[:,year[0]-1:year[1],:] 
        # Scale migrants
...
dump(results, 'experiment_result/preparatory_experiment_threshold_3_multiplier_fine_tuning_C0_01.pkl')